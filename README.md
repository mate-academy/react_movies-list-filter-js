[DEMO LINK](https://artemvlasiuk.github.io/react_movies-list-filter-js/)
# Movies list - Filter
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_movies-list-filter-js/) and add it to the PR description.
