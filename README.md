...
> Here is [the working version](https://mate-academy.github.io/react_movies
-list-filter/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Culpam.github.io/react_movies-list-filter-js/) and add it to the PR description.
