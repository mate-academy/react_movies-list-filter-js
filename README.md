...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vlad-ptashnichenko.github.io/react_movies-list-filter-js/) and add it to the PR description.
