...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vitalii-fedusov.github.io/react_movies-list-filter-js/) and add it to the PR description.
