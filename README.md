...
- Replace `RuslanMudryi` with your Github username in the [DEMO LINK](https://RuslanMudryi.github.io/react_movies-list-filter-js/) and add it to the PR description.
