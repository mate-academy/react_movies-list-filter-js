...
- Replace `Valentyna08` with your Github username in the [DEMO LINK](https://Valentyna08.github.io/react_movies-list-filter-js/) and add it to the PR description.
