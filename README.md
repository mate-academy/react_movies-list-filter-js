...
- Implement a solution following the [React task guideline](https://gnpm startithub.com/mate-academy/react_task-guideline#react-tasks-guideline).
- Open one more terminal and run tests with `npm test` to ensure your solution is correct.
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://veronica-shyian.github.io/react_movies-list-filter-js/) and add it to the PR description.
